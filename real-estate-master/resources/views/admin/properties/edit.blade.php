            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="form-group">
                        ...
                        <label for="featured">امکانات</label>
                    </div>
                ...
                <div class="body">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line {{$errors->has('purpose') ? 'focused error' : ''}}">
                            <label>فروش یا اجاره</label>
                            <select name="purpose" class="form-control show-tick">
                                <option value="">-- Please select --</option>
                                <option value="sale" {{ $property->purpose=='sale' ? 'selected' : '' }}>فروشی</option>
                                <option value="rent" {{ $property->purpose=='rent' ? 'selected' : '' }}>اجاره</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line {{$errors->has('type') ? 'focused error' : ''}}">
                            ...
                            <select name="type" class="form-control show-tick">
                                ...
                                <option value="house" {{ $property->type=='house' ? 'selected' : '' }}>خانه ویلایی</option>
                                <option value="apartment" {{ $property->type=='apartment' ? 'selected' : '' }}>آپارتمان</option>
                            </select>
                        </div>
                    </div>
